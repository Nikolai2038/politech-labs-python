#Программа обученной нейронной сети выводит вероятности всех возможных
#вариантов результатов классификации (отнесения к нескольким классам)
#Предусмотрена возможность задания порога распознавания level.
#Если все полученные вероятности меньше level, выводится сообщение
